...
const sections = [
  ...
  },
  {
    name: 'Дополнительно',
    features: [
      { name: 'Базовый курс', tiers:{ time: '40 мин', price: '9900 ₽', other: '2 месяца 16 занятий 2 теста' }  },
      { name: 'Английский для отдыха', tiers: { time: '40 мин', price: '4000 ₽', other: '2 месяца 16 занятий 2 теста'  }  },
