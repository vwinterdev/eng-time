    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
        ...
        <div class="mt-10 grid max-w-xl grid-cols-1 gap-8 text-base leading-7 text-gray-700 lg:max-w-none lg:grid-cols-2">
          <div>
            <h1 class="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Мы предлагаем широкий выбор программ обучения:</h1>
            <p class="mt-8">Общий курс (разговорная практика, грамматика, чтение);
              Подготовка к экзаменам (ОГЭ,ЕГЭ);
              Специализированные курсы (английский для путешествий, подготовка к собеседованиям).
              </p>
